...
public:
    ...
    // Eventos de entrada do jogador humano
    void onKeyDown(char key);

    // Disparo direto para o modo DEMO: julga o grupo especificado com precisão,
    // eliminando falso positivo de colisão de acordes, duplicidade de hits e timeout prematuro.
    void triggerDemoHit(size_t groupIndex, JudgementType type, double hitTimestamp);
